...
"sim_title": "Live Traffic Flow Simulation",
    ...
    "dp_now": "Now",
    "dp_actual": "Actual",
    "dp_actuals": "Record actuals",
    "dp_ontrack": "On target",
    "dp_ops_title": "Capacity planner",
    "dp_ops_desc": "Turn the monthly concrete target into an everyday task for every department.",
    "dp_ops_assume": "Assumptions",
    "dp_ops_target": "Target",
    "dp_ops_rev": "Revenue est.",
    "dp_ops_dayreq": "required daily (w/ buffer)",
    "dp_ops_util": "utilisation",
    "dp_ops_mixers": "mixers",
    "dp_ops_trips": "trips / day",
    "dp_ops_cycle": "cycle",
    "dp_ops_shift": "shift",
    "dp_a_days": "Working days / mo",
    "dp_a_load": "Mixer load (m³)",
    "dp_a_shift": "Shift (h)",
    "dp_a_unload": "Load+unload (min)",
    "dp_a_reserve": "Buffer %",
    "dp_a_price": "Price / m³",
    "dp_a_sample": "Sample every (m³)",
    "dp_ops_samples": "samples",
    "dp_ops_every": "sampling every",
    "dp_unit_min": "min",
    "dp_rm_title": "Development roadmap",
    "dp_rm_goal": "From today to the goal",
    "dp_rm_months": "months",
    "dp_rm_config": "Define current → target → time",
    "dp_rm_rebase": "Re-baseline after review",
    "dp_rm_brain": "The advisor",
    "dp_rm_brain_desc": "Thinks like the sharpest planner — EVM, variance & corrective action.",
    "dp_rm_tasks": "Who carries the goal",
    "dp_rm_rebaselined": "Plan re-baselined after the last review.",
    "dp_rm_config_title": "Plan parameters",
    "dp_rm_apply": "Apply plan",
    "dp_rm_eval": "Phase evaluation",
    "dp_rm_actual": "Actual",
    "dp_rm_real_month": "Real month",
    "dp_rm_notes": "Notes",
    "dp_rm_save": "Save",
    "dp_rm_done_past": "phase closed",
    "dp_rm_rev_log": "Phase review log",
    "dp_rm_result": "vs plan",
    "dp_rm_met": "met",
    "dp_rm_missed": "missed",
    "dp_rm_planned_cum": "Planned (cum.)",
    "dp_rm_actual_cum": "Actual (cum.)",
    "dp_mgmt_pos_plant_mgr": "Plant manager",
    "dp_mgmt_pos_station_mgr": "Station manager",
    "dp_mgmt_pos_quality": "Quality supervisor",
    "dp_mgmt_pos_sales": "Sales supervisor",
    "dp_mgmt_pos_logistics": "Logistics supervisor",
    "dp_mgmt_pos_hr": "HR / manpower",
    "dp_mgmt_pos_finance": "Finance manager",
    "dp_mgmt_st_draft": "Draft",
    "dp_mgmt_st_mgmt_ok": "Management OK",
    "dp_mgmt_st_finance_ok": "Finance OK",
    "dp_mgmt_st_distributed": "Distributed",
    "dp_mgmt_st_monitoring": "Monitoring",
    "dp_mgmt_st_todo": "To do",
    "dp_mgmt_st_doing": "In progress",
    "dp_mgmt_st_done": "Done",
    "dp_mgmt_prob_open": "Open",
    "dp_mgmt_prob_solved": "Solved",
    "dp_mgmt_role_mgmt": "Management",
    "dp_mgmt_role_finance": "Finance",
    "dp_mgmt_role_hr": "HR",
    "dp_mgmt_approve_note": "plan approved",
    "dp_mgmt_dist_note": "tasks distributed to the people in charge",
    "dp_mgmt_monitor_note": "monitoring started",
    "dp_mgmt_fin_note": "funding approved:",
    "dp_mgmt_fin_reject": "Reject",
    "dp_mgmt_sec": "Execution management",
    "dp_mgmt_title": "Execution management",
    "dp_mgmt_status": "status",
    "dp_mgmt_desc": "Management approves the plan; finance secures the money; tasks are delegated by job title; HR fills the team.",
    "dp_mgmt_print": "Print the plan",
    "dp_mgmt_act_mgmt": "Approve plan / send it on",
    "dp_mgmt_act_dist": "Distribute to those in charge",
    "dp_mgmt_act_mon": "Start monitoring",
    "dp_mgmt_act_restart": "Restart cycle",
    "dp_mgmt_fin_need": "Funding needed",
    "dp_mgmt_fin_approve": "Approve funding",
    "dp_mgmt_fin_approved_note": "Funding approved",
    "dp_mgmt_fin_approved": "Approved",
    "dp_mgmt_tasks_title": "Tasks by job title",
    "dp_mgmt_add_task": "Add task",
    "dp_mgmt_task_new": "New task",
    "dp_mgmt_no_tasks": "No tasks yet",
    "dp_mgmt_task": "Task",
    "dp_mgmt_position": "Job title",
    "dp_mgmt_cost": "cost",
    "dp_mgmt_cost_total": "total cost",
    "dp_mgmt_eval": "evaluation",
    "dp_mgmt_eval_save": "Save",
    "dp_mgmt_add_follow": "Follow-up note",
    "dp_mgmt_follow": "Follow",
    "dp_mgmt_hr_title": "HR — fill the team",
    ...
    "dp_mgmt_staff_filled": "team request approved",
    "dp_mgmt_staff_declined": "team request declined",
    "dp_mgmt_cross": "cross-functional",
    "dp_mgmt_problem_title": "Problem scheduler",
    "dp_mgmt_problem_outside": "even outside the plan",
    "dp_mgmt_prob_new": "New problem",
    "dp_mgmt_add_prob": "Schedule",
    "dp_mgmt_no_probs": "No scheduled problems",
    "dp_mgmt_sev_low": "Low",
    "dp_mgmt_sev_med": "Medium",
    "dp_mgmt_sev_high": "High",
    "dp_mgmt_month": "Month",
    "dp_mgmt_prob": "Problem",
    "dp_mgmt_tbl_summary": "Plan summary",
    "dp_mgmt_tbl_steps": "Work steps",
    "dp_mgmt_tbl_current_target": "current → target",
    "dp_mgmt_tbl_tasks": "Delivered tasks",
    "dp_mgmt_tbl_problems": "Scheduled problems",
    "dp_mgmt_tbl_follow": "follow-up (colored)",
    "dp_mgmt_current": "Current",
    "dp_mgmt_target": "Target",
    "dp_mgmt_horizon": "Horizon",
    "dp_mgmt_planned": "Planned",
    "dp_mgmt_step_draft_note": "management draws the plan",
    "dp_mgmt_step_mgmt_note": "management review",
    "dp_mgmt_step_finance_note": "money secured",
    "dp_mgmt_step_dist_note": "each manager follows his section / station manager follows all",
    "dp_mgmt_step_monitor_note": "follow-up & evaluations",
    "dp_cpm_critical": "Critical",
    "dp_cpm_days": "days",
    "dp_cpm_float": "Float",
    "dp_cpm_duration": "Duration",
    "dp_cpm_set_dur": "Set duration",
    "dp_cpm_add_pred": "Add predecessor",
    "dp_cpm_critical_tasks": "critical tasks",
    "dp_cpm_project_dur": "Project duration",
    "dp_wbs_title": "Work Breakdown Structure (WBS)",
    "dp_gantt_title": "Gantt Chart",
    "dp_baseline_title": "Baselines",
    "dp_baseline_save": "Save baseline",
    "dp_baseline_phases": "phases",
    "dp_baseline_tasks": "tasks",
    "dp_baseline_restore": "Restore",
    "dp_baseline_none": "No baselines saved yet",
    "dp_rm_risk": "Risk register",
    "dp_rm_risk_clear": "No open risks",
    "dp_rm_risk_score": "score",
    "dp_rm_risk_mitigated": "mitigated",
    "dp_rm_risk_accepted": "accepted",
    "dp_rm_risk_schedule": "Schedule-slip risk",
    "dp_rm_risk_capacity": "Capacity risk",
    "dp_rm_risk_schedule_mit": "corrective: raise pace to",
    "dp_rm_risk_capacity_mit": "corrective: lift capacity +",
    "dp_rm_risk_extend": "or extend to",
    "dp_rm_pending": "awaiting turn",
    "dp_rm_phase": "Phase",
    "dp_rm_done": "Done",
    "dp_rm_active": "Active",
    "dp_rm_planned": "Planned",
    "dp_rm_planned_end": "Planned end",
    "dp_rm_idle": "Not evaluated yet",
    "dp_rm_on_track": "On track",
    "dp_rm_late": "Behind schedule",
    "dp_rm_spi": "SPI",
    "dp_rm_variance": "Variance",
    "dp_rm_progress": "Progress",
    "dp_rm_no_eval": "No evaluation yet — close a phase to unlock EVM.",
    "dp_rm_remaining": "Remaining",
    "dp_rm_needed": "needed / mo",
    "dp_rm_rate": "required / mo",
    "dp_rm_growth": "growth / mo",
    "dp_rm_verdict": "Verdict",
    "dp_rm_current": "Current state",
    "dp_rm_target": "Target (goal)",
    "dp_rm_phase_count": "Phases",
    "dp_rm_eac": "Trend forecast",
    "dp_rm_eac_months": "Forecast time",
    "dp_rm_miss": "milestone miss",
    "dp_rm_advice": "Advisor",
    "dp_rm_advice_faster": "raise pace to",
    "dp_rm_advice_extend": "or extend to",
    "dp_rm_or": "or",
    "dp_rm_report": "Management report",
    "dp_rm_evals": "Phase reviews",
    "dp_rm_feed": "Today\u2019s job for every department",
    "dp_rm_feas": "Feasibility on plant floor",
    "dp_rm_feas_ok": "Plants can deliver this phase.",
    "dp_rm_feas_warn": "Not feasible at current capacity",
    "dp_rm_timeline": "Timeline",
    "dp_rm_scen": "Decision scenarios",
    "dp_rm_scen_keep": "Keep the plan as is",
    "dp_rm_scen_keep_desc": "if you keep the current pace the goal slips past its deadline",
    "dp_rm_scen_pace": "Re-baseline the pace",
    "dp_rm_scen_pace_desc": "finish on target by raising the monthly pace to",
    "dp_rm_scen_pace_ok": "you\u2019re on target \u2014 hold this pace",
    "dp_rm_scen_extend": "Extend the horizon",
    "dp_rm_scen_extend_desc": "hold the pace and extend the schedule by",
    "dp_rm_reco": "recommended",
    "dp_rm_choose": "Choose this",
    "dp_rm_keep": "Accept the slip",
    "dp_rm_on_time": "on time",
    "dp_cancel": "Cancel",
    "tab_main": "Reference",
    "tab_case": "Case Study",
    "nav_countries": "Countries",
    "nav_field": "Field Data (Case)",
    "rr_mode": "Simulation Mode",
    "exp_tools": "Export & Tools",
    "fd_title": "Real Field Data",
